...
namespace EldritchArcana
{
    static class ExperimentalSpells
    {
        ...
        public static void LoadEmergencyForceSphere()
        {
            ...
            var seamantleBuff = library.Get<BlueprintBuff>("1c05dd3a1c78b0e4e9f7438a43e7a9fd");
            ...
            buff.SetComponents(
                ...
                Helpers.Create<AddCondition>(c => c.Condition = UnitCondition.ImmuneToAttackOfOpportunity),
            ...
            //buff.FxOnStart = seamantleBuff.GetComponent<fx>();
            //buff.
            ...
            //spell.AddToSpellList(Helpers.bardSpellList, 4);
            Helpers.AddSpell(spell);
